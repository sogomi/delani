(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[11],{"5JRF":function(e,t,n){"use strict"
var o=n("rePB")
var r=n("1OyB")
var a=n("vuIU")
var i=n("md7G")
...
var G=(U=Object(f["a"])("7.0.0",null,"Use Text from ui-text instead"),v=Object(y["themeable"])(j,B),U(k=v(k=(x=w=function(e){Object(l["a"])(t,e)
...
b.cancel()}}}},"M8//":function(e,t,n){"use strict"
var o=n("rePB")
var r=n("1OyB")
var a=n("vuIU")
var i=n("md7G")
...
var M=(C=Object(G["a"])(),z=Object(B["themeable"])(S,F),C(L=z(L=(R=H=function(e){Object(b["a"])(t,e)
function t(){var e
Object(r["a"])(this,t)
...
var r=Object(x["a"])(e.props.maxHeight,Object(_["a"])(Object(l["a"])(e)))
...
else if(Object(x["a"])(e.props.height,Object(_["a"])(Object(l["a"])(e)))>e._textarea.scrollHeight){e._textarea.style.overflowY="auto"
...
this._request=Object(U["a"])(this.grow)}}},{key:"focus",value:function(){this._textarea.focus()}},{key:"render",value:function(){var e,n=this
var r=this.props,a=r.autoGrow,i=r.placeholder,c=r.value,l=r.defaultValue,b=r.disabled,s=r.readOnly,u=r.required,p=r.width,h=r.height,f=r.maxHeight,_=r.textareaRef,m=r.resize,j=r.size
var U=Object(O["a"])(this.props,t.propTypes)
var v=(e={},Object(o["a"])(e,F.textarea,true),Object(o["a"])(e,F[j],true),Object(o["a"])(e,F.disabled,b),e)
var k={width:p,resize:m,height:a?null:h,maxHeight:f}
var w=d.a.createElement("textarea",Object.assign({},U,{value:c,defaultValue:l,placeholder:i,ref:function(e){n._textarea=e
for(var t=arguments.length,o=new Array(t>1?t-1:0),r=1;r<t;r++)o[r-1]=arguments[r]
_.apply(n,[e].concat(o))},style:k,id:this.id,required:u,"aria-required":u,"aria-invalid":this.invalid?"true":null,disabled:b||s,className:y()(v),onChange:this.handleChange}))
return d.a.createElement(g["FormField"],Object.assign({},Object(O["c"])(this.props,g["FormField"].propTypes),{vAlign:"top",id:this.id,ref:function(e){n._node=e}}),d.a.createElement("div",{className:F.layout,style:{width:p,maxHeight:f},ref:this.handleContainerRef},w,b||s?null:d.a.createElement("span",{className:F.outline,"aria-hidden":"true"})))}},{key:"minHeight",get:function(){return this._textarea.style.minHeight}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"focused",get:function(){return Object(v["a"])(this._textarea)}},{key:"value",get:function(){return this._textarea.value}}])
t.displayName="TextArea"
return t}(s["Component"]),H.propTypes={label:p.a.node.isRequired,id:p.a.string,size:p.a.oneOf(["small","medium","large"]),layout:p.a.oneOf(["stacked","inline"]),autoGrow:p.a.bool,resize:p.a.oneOf(["none","both","horizontal","vertical"]),width:p.a.string,height:p.a.string,maxHeight:p.a.oneOfType([p.a.number,p.a.string]),messages:p.a.arrayOf(g["FormPropTypes"].message),inline:p.a.bool,placeholder:p.a.string,disabled:p.a.bool,readOnly:p.a.bool,required:p.a.bool,textareaRef:p.a.func,defaultValue:p.a.string,value:Object(f["a"])(p.a.string),onChange:p.a.func},H.defaultProps={size:"medium",autoGrow:true,resize:"none",inline:false,messages:[],disabled:false,readOnly:false,textareaRef:function(e){},layout:"stacked",id:void 0,value:void 0,defaultValue:void 0,onChange:void 0,required:false,placeholder:void 0,width:void 0,height:void 0,maxHeight:void 0},R))||L)||L)},cClk:function(e,t,n){"use strict"
...
//# sourceMappingURL=11-c-53880cce55.js.map